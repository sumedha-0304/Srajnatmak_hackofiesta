  ...
  <main id="main">
    <section id="team" class="team">
     ...
     <form class="modal-content" method="POST" action="">
      ...
      <hr>
      <label for="group"><b>Search blood group :</b></label>
              ...
              <thead>
                      ...
                      <tbody>
                            ...
                            if(isset($_POST['search'])){
                                ...
                                $query = "select * from bloodbank b inner join hospitaldetails h on b.hospid=h.hospid  where b.bgroup='$group'";
                                ...
                                echo "<th>Name</th>
                                    ...
                                    {
                                      $_SESSION['amount']=$object->amount;
                                      $_SESSION['hospid']=$object->hospid;
                                      $_SESSION['bgroup']=$object->bgroup;
                                    ?><tr>
                                      ...
                                      <td>
                                        <a href="requestform.php"><button class="btn-btn-primary" name="bloodrequest" id="bloodrequest" >Request</button></a>
                                      </td>
                                    </tr><?php                                  }
                                    }
                                    else {
