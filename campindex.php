...
$query = "select * from campdetails";
$data = mysqli_query($conn, $query);
if ($data) {
  $object = $data->fetch_object();
  $name = $object->name;
  $campid = $object->campid;
        ...
        <div class="row">
          <div class="col-lg-4" style="background-color: transparent;">
            <div class="member" data-aos="zoom-in">
			  ...
			  <h4><b><u>PROFILE :</b></u></h4><br>
                <h4>Name - <?php echo $name; ?> </h4>
                <h4>ID - <?php echo $campid; ?> </h4>
          ...
          <div class="col-lg-8">
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="card">
                  <h3>Add Camp</h3>
                  <form action="camp.php">
                    <button class="btn btn-secondary" name="dashboard">Add</button>
                  </form>
                </div>
              </div>
